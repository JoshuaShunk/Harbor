...
<Info>Alias: `harbor stop`</Info>

Drop anchor on a running server (stop the process).

```sh
harbor anchor --name <name>
```
...
Scout the seas for new MCP servers on the [Smithery](https://smithery.ai) registry.
